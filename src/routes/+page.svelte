...
<section id="about" class="section">
  ...
  <h3>Who am I?</h3>
  <p>
    I'm Tristen, a software engineering student at RIT graduating Dec 2026. I
    most recently spent a summer at M&T Bank building a Java test orchestration
    platform from scratch, and I'm looking for full-time roles starting after I
    graduate. I care a lot about process and ethics in software.
    The why behind what we build is really important to me, and I want to make
    sure that what we build is accessible to all kinds of people, is
